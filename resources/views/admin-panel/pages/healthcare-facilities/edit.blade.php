        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">Edit FASKES</div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-6 col-12 col-sm-6">
                    ...
                    @endif
                    <form action="{{ route('admin-panel.healthcare-facilities.update', $healthcareFacilities->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
						@method('PUT')
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="district_id" id="district_id" class="form-control select2">
										...
										<option value="{{ $data->id }}" {{ $data->id == $healthcareFacilities->district_id ? 'selected' : '' }}>{{ $data->name }}</option>
										@endforeach
									</select>
                                </div>
                                <div class="form-group">
                                    <label for="name">Nama <span class="text-danger">*</span></label>
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $healthcareFacilities->name }}">
                                </div>
                                <div class="form-group">
                                    <label for="address">Alamat <span class="text-danger">*</span></label>
                                    <textarea name="address" id="address" cols="30" rows="30" class="form-control">{{ $healthcareFacilities->address }}</textarea>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type" class="form-control select2">
                                                ...
                                                <option value="public_health_center" {{ $healthcareFacilities->type == 'public_health_center' ? 'selected' : ''}}>PUSKESMAS</option>
                                                <option value="hospital" {{ $healthcareFacilities->type == 'hospital' ? 'selected' : ''}}>Rumah Sakit</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="contact_information" id="contact_information" class="form-control" value="{{ $healthcareFacilities->contact_information }}">
                                        </div>
                                    </div>
                                </div>
                                <div id="map"></div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="latitude" id="latitude" class="form-control" value="{{ $healthcareFacilities->latitude }}" readonly>
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="longitude">Longitude</label>
                                        <input type="text" name="longitude" id="longitude" class="form-control" value="{{ $healthcareFacilities->longitude }}" readonly>
                                    </div>
                                </div>
