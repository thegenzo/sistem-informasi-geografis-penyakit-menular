        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">Edit Dokumen</div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-6 col-12 col-sm-6">
                    ...
                    @endif
                    <form action="{{ route('admin-panel.document.update', $document->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
						@method('PUT')
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan Nama Dokumen" value="{{ $document->name }}">
                                </div>
                                <div class="form-group">
                                    <label for="description">Deskripsi Dokumen <span class="text-danger">*</span></label>
                                    <input type="text" name="description" id="description" class="form-control" placeholder="Masukkan Deskripsi Dokumen" value="{{ $document->description }}">
                                </div>
                                <div class="form-group">
                                    <label class="d-block">Tipe Dokumen</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" id="type_upload" value="file" @if($document->type == 'file') checked @endif>
                                        <label class="form-check-label" for="type_upload">
                                        File Upload
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="type" value="url" id="type_url" @if($document->type == 'url') checked @endif>
                                        <label class="form-check-label" for="type_url">
                                        Link / URL
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group" id="file_upload" @if($document->type !== 'file') style="display: none" @endif>
                                ...
                                <div class="form-group" id="url_input" @if($document->type !== 'url') style="display: none" @endif>
                                    <label for="">Link / URL <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="url" @if($document->type == 'url') value="{{ $document->url }}" @endif>
                                </div>
                            </div>
                        </div>
