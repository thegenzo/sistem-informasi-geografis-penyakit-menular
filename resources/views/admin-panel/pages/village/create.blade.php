        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item active">Tambah Kelurahan</div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-6 col-12 col-sm-6">
                    ...
                    @endif
                    <form action="{{ route('admin-panel.villages.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-header">
                                <h4>Masukkan Data Kelurahan</h4>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="district_id" id="district_id" class="form-control select2">
                                        ...
                                        @empty
                                            <option value="" selected disabled>Data kecamatan kosong</option>
                                        @endforelse
                                    </select>
                                </div>
                                <div class="form-group">
