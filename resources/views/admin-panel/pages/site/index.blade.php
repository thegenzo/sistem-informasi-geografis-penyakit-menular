    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Manajemen Situs</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item active">Manajemen Situs</div>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <a href="{{ route('admin-panel.site.create') }}" class="btn btn-icon icon-left btn-primary mb-4"><i
                            class="fas fa-plus"></i>Tambah Situs</a>
                </div>
            </div>
            <div class="row">
                                    ...
                                    @forelse ($site as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="{{ route('admin-panel.site.destroy', $data->id) }}" method="POST" class="d-inline swal-confirm">
                                                    @csrf
                                                    @method('DELETE')
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" style="font-weight: bold; font-size: 18px;"
                                                class="text-center">Data Situs Kosong</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.swal-confirm').click(function(event) {
                ...
                swal({
                        title: `Yakin Hapus Situs?`,
                        text: "Situs yang terhapus tidak dapat dikembalikan",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
